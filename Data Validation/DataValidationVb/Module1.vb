...
Module Module1
    ...
    Sub Main()
        ...
        Dim ws As ExcelWorksheet = ef.Worksheets.Add("Data Validation")

        ws.Cells(0, 0).Value = "Data validation examples:"

        ws.Cells(2, 1).Value = "Decimal greater than 3.14 (on entire row 4):"
        ws.DataValidations.Add(New DataValidation(ws.Rows(3).Cells) With {
        ...
        ws.DataValidations.Add(New DataValidation(ws, "C8") With {
        ...
        ws.DataValidations.Add(New DataValidation(ws.Cells.GetSubrange("C14", "E15")) With {
