...
Module Module1
    ...
    Sub Main()
        ...
        Dim ws As ExcelWorksheet = ef.Worksheets.Add("Data Types")
        ...
        ws.Cells(row, 1).SetValue(CType(1234, UInteger))
        ...
        ws.Cells(row, 1).SetValue(Single.MaxValue)
